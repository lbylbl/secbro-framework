...
<head>
	...
	<link href="<%=request.getContextPath() %>/jquery/jquery-1.11.2.min.js" rel="stylesheet" type="text/css">	
</head>
<body class="templatemo-bg-image-1">
	<div class="container">
		<div class="col-md-12">
			<form class="form-horizontal templatemo-login-form-2" role="form" action="login.htm" method="post">
				<div class="row">
					<div class="col-md-12">
